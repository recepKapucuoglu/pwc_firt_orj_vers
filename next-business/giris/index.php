...
if(isset($_SESSION["isim"])){
    header("Location: https://www.okul.pwc.com.tr/platform/giris/live.php");
}
...
<div class="body-inner">
    ...
    <section class="ts-pricing gradient" style="background-image: url(https://www.okul.pwc.com.tr/platform/images/background-2020.jpg);">
            ...
            <div class="row">
                <div class="col-lg-12">
                    <h2 class="section-title white">
                        <span style="
    text-transform: none;
">PwC 19. Çözüm Ortaklığı Platformu</span>Giriş Ekranı</h2>
                    <?php
                    if($_SESSION["error"]){
...
">
                        ...
                        <div class="text-center"><br>
							...
							<a href="https://onlinebagis.tev.org.tr/BursFonu?link=2110" target="_blank"><img src="../images/bagis.png" style="
    width: 100%;
    height: auto;
    margin-top: 5rem;
"></a>

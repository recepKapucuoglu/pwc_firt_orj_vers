...
">
				...
				<p class="text-center font-weight-bold"><i class="fa fa-info-circle" aria-hidden="true"></i> Workshop kayıtları en kısa sürede <a href="https://www.okul.pwc.com.tr/">Business School</a> sayfamıza yüklenecektir.</p>
			</section>
    <section class="ts-faq-sec mt-5" style="margin-top: 30px !important; min-height: 700px;">
        <div class="container">
            <iframe style="  position: absolute;top: 0;left: 0;bottom: 0;right: 0;width: 100%;height: 100%;" frameborder="0" src="https://www.okul.pwc.com.tr/platform/manage/index.php"></iframe>
        </div><!-- .container end -->
    </section>

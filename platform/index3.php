...
function retrieveData($day){
    ...
    $sql = "SELECT * FROM timetabless WHERE day='$day'";
...
function addBasket(data_id, data_title, data_start, data_end, day, value) {
   var element = document.getElementById("s" + data_id);
  if (value) {
     // (3, 4)
     if(data_id == '3') { document.getElementsByClassName("c4")[0].style.display = "none"; }
     if(data_id == '4') { document.getElementsByClassName("c3")[0].style.display = "none"; }
     //(5, 40)
     if(data_id == '5') { document.getElementsByClassName("c40")[0].style.display = "none"; }
     if(data_id == '40') { document.getElementsByClassName("c5")[0].style.display = "none"; }
     //(41, 42)
     if(data_id == '41') { document.getElementsByClassName("c42")[0].style.display = "none"; }
     if(data_id == '42') { document.getElementsByClassName("c41")[0].style.display = "none"; }
     //(44, 45)
     if(data_id == '44') { document.getElementsByClassName("c45")[0].style.display = "none"; }
     if(data_id == '45') { document.getElementsByClassName("c44")[0].style.display = "none"; }
     //(47, 48)
     if(data_id == '47') { document.getElementsByClassName("c48")[0].style.display = "none"; }
     if(data_id == '48') { document.getElementsByClassName("c47")[0].style.display = "none"; }
     //(49, 50)
     if(data_id == '49') { document.getElementsByClassName("c50")[0].style.display = "none"; }
     if(data_id == '50') { document.getElementsByClassName("c49")[0].style.display = "none"; }
     //(51, 52)
     if(data_id == '51') { document.getElementsByClassName("c52")[0].style.display = "none"; }
     if(data_id == '52') { document.getElementsByClassName("c51")[0].style.display = "none"; }
     //(55, 56)
     if(data_id == '55') { document.getElementsByClassName("c56")[0].style.display = "none"; }
     if(data_id == '56') { document.getElementsByClassName("c55")[0].style.display = "none"; }
     //(60, 61)
     if(data_id == '60') { document.getElementsByClassName("c61")[0].style.display = "none"; }
     if(data_id == '61') { document.getElementsByClassName("c60")[0].style.display = "none"; }
     //(62, 63)
     if(data_id == '62') { document.getElementsByClassName("c63")[0].style.display = "none"; }
     if(data_id == '63') { document.getElementsByClassName("c62")[0].style.display = "none"; }
     //(65, 66)
     if(data_id == '65') { document.getElementsByClassName("c66")[0].style.display = "none"; }
     if(data_id == '66') { document.getElementsByClassName("c65")[0].style.display = "none"; }
     //(68, 69)
     if(data_id == '68') { document.getElementsByClassName("c69")[0].style.display = "none"; }
     if(data_id == '69') { document.getElementsByClassName("c68")[0].style.display = "none"; }
     element.style.background = "#dedede";
    eventStorage[data_id] = data_title + "#" + data_start + "#" + data_end + "#" + day;
  } else {
       // (3, 4)
     if(data_id == '3') { document.getElementsByClassName("c4")[0].style.display = ""; }
     if(data_id == '4') { document.getElementsByClassName("c3")[0].style.display = ""; }
     //(5, 40)
     if(data_id == '5') { document.getElementsByClassName("c40")[0].style.display = ""; }
     if(data_id == '40') { document.getElementsByClassName("c5")[0].style.display = ""; }
     //(41, 42)
     if(data_id == '41') { document.getElementsByClassName("c42")[0].style.display = ""; }
     if(data_id == '42') { document.getElementsByClassName("c41")[0].style.display = ""; }
     //(44, 45)
     if(data_id == '44') { document.getElementsByClassName("c45")[0].style.display = ""; }
     if(data_id == '45') { document.getElementsByClassName("c44")[0].style.display = ""; }
     //(47, 48)
     if(data_id == '47') { document.getElementsByClassName("c48")[0].style.display = ""; }
     if(data_id == '48') { document.getElementsByClassName("c47")[0].style.display = ""; }
     //(49, 50)
     if(data_id == '49') { document.getElementsByClassName("c50")[0].style.display = ""; }
     if(data_id == '50') { document.getElementsByClassName("c49")[0].style.display = ""; }
     //(51, 52)
     if(data_id == '51') { document.getElementsByClassName("c52")[0].style.display = ""; }
     if(data_id == '52') { document.getElementsByClassName("c51")[0].style.display = ""; }
     //(55, 56)
     if(data_id == '55') { document.getElementsByClassName("c56")[0].style.display = ""; }
     if(data_id == '56') { document.getElementsByClassName("c55")[0].style.display = ""; }
     //(60, 61)
     if(data_id == '60') { document.getElementsByClassName("c61")[0].style.display = ""; }
     if(data_id == '61') { document.getElementsByClassName("c60")[0].style.display = ""; }
     //(62, 63)
     if(data_id == '62') { document.getElementsByClassName("c63")[0].style.display = ""; }
     if(data_id == '63') { document.getElementsByClassName("c62")[0].style.display = ""; }
     //(65, 66)
     if(data_id == '65') { document.getElementsByClassName("c66")[0].style.display = ""; }
     if(data_id == '66') { document.getElementsByClassName("c65")[0].style.display = ""; }
     //(68, 69)
     if(data_id == '68') { document.getElementsByClassName("c69")[0].style.display = ""; }
     if(data_id == '69') { document.getElementsByClassName("c68")[0].style.display = ""; }
    delete eventStorage[data_id];
   element.style.background = "none";
  }
  // Fill the hidden input to store ids
  var selectedIds = Object.keys(eventStorage).join();
  document.getElementById("selectedVideos").value = selectedIds;
  //Render courses
  renderBasket();
}
...
function renderBasket() {
  ...
  var buildString = "";
  var mondayString = "<ul>";
  var tuesdayString = "<ul>";
  var wednesdayString = "<ul>";
  var thursdayString = "<ul>";
  var fridayString = "<ul>";

  Object.keys(eventStorage).forEach(function(key) {
    buildString = eventStorage[key];
      var res = buildString.split("#");
      var title = res[0];
      var start = res[1];
      var end = res[2];
      var day = res[3];
      //console.log(day);
       switch(day){
          case "monday":
           mondayString += "<li><b>" + start + " - " + end + "</b> " + title + "</li>";
          break;
          case "tuesday":
           tuesdayString += "<li><b>" + start + " - " + end + "</b> " + title + "</li>";
          break;
          case "wednesday":
           wednesdayString += "<li><b>" + start + " - " + end + "</b> " + title + "</li>";
          break;
          case "thursday":
           thursdayString += "<li><b>" + start + " - " + end + "</b> " + title + "</li>";
          break;
          case "friday":
           fridayString += "<li><b>" + start + " - " + end + "</b> " + title + "</li>";
          break;
      }
  });
  mondayString += "</ul>";
  ...
  thursdayString += "</ul>";
  fridayString += "</ul>";
  monday.innerHTML = mondayString
  tuesday.innerHTML = tuesdayString
  wednesday.innerHTML = wednesdayString
  thursday.innerHTML = thursdayString
  friday.innerHTML = fridayString
}
// ajax form
function send_form(){

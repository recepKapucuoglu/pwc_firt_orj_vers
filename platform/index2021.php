<?php
exit(header("Location: http://www.okul.pwc.com.tr"));
...
<html lang="tr">
<head>
	<title>20. Çözüm Ortaklığı Platformu</title>
	...
	<link rel="stylesheet" type="text/css" href="assets/css/style.css?v=1.10.11">

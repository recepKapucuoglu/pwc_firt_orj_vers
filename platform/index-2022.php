...
<head>
	...
	<meta name="viewport" content="width=device-width, initial-scale=1.0">
 	<meta name="description" content="PwC 20. Çözüm Ortaklığı Platformu">
	...
	<link rel="stylesheet" type="text/css" href="assets/css/animate.css?v=1.10.12">
	<link rel="stylesheet" type="text/css" href="assets/css/bootstrap.min.css?v=1.10.12">
	<link rel="stylesheet" type="text/css" href="assets/css/all.min.css?v=1.10.12">
	<link rel="stylesheet" type="text/css" href="assets/css/lightcase.css?v=1.10.12">
	<link rel="stylesheet" type="text/css" href="assets/css/swiper.min.css?v=1.10.12">
	<link rel="stylesheet" type="text/css" href="assets/css/style.css?v=1.10.12">
...
<body>
	...
	<div class="header-section d-none d-lg-block">
		<div class="header-bottom">
			<nav class="primary-menu sticky-nav nav-down">
    ...
    <section class="banner-section hidden">
		<div class="container-fluid">
			<div class="row">
						...
						<div class="banner-left banner" style="background-image: url(assets/images/banner/01.jpg)">
							<div class="banner-lc">
								<div class="banner-left-content">
									<h2> 20. Çözüm <span>Ortaklığı Platformu</span></h2>
								</div>
								<div class="banner-left-content">
									<p class="digitalRose" style="font-size:2.2rem !important">Yeni Denklem</p>
									<p class="digitalRose" style="font-size:2.1rem !important; margin-top: 5px;">Çözümü Birlikte Üretmek</p>
								</div>
								<div class="banner-left-content">
									<p style="font-size:1.1rem !important; margin-top:15px; color: #eb8c00; font-weight: 900;">#pwcplatform</p>
								</div>
							</div>
						</div>
					</div>
				...
				<div class="col-xl-6">
					<div class="row">
						<div class="banner-right banner" style="background-image: url(assets/images/banner/hero-2.jpg)">
					...
					<div class="col-lg-6 col-12">
						<div class="newevent-right">
							<div class="acive-content wow fadeInUp" data-wow-duration="1s" data-wow-delay=".4s">
								<h2>20. Çözüm Ortaklığı Platformu</h2>
            ...
            <div class="grid  wow fadeInUp" data-wow-duration="1s" data-wow-delay=".3s">
              	<div class="element-item transition" data-category="transition">
                  	<div class="element-item-inner">
                  		<a href="https://www.youtube.com/embed/swf6p162fvM" data-rel="lightcase" class="cata-icon">
				...
				<div class="element-item alkali metal" data-category="transition">
					<div class="element-item-inner">
						<a href="assets/images/fotograflar/14.jpg" data-rel="lightcase" class="cata-icon">
						  <i class="fas fa-expand-arrows-alt"></i>
						 </a>
						<a href="assets/images/fotograflar/14.jpg" data-rel="lightcase"><img src="assets/images/fotograflar/14.jpg" alt="gallery"></a>
				   </div>
				</div>

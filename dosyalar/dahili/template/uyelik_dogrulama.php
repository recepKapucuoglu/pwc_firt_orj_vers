				...
				<td align="center" valign="top">
					...
					<table border="0" cellpadding="0" cellspacing="0" style="background-color: rgb(255, 255, 255); border: 1px solid rgb(222, 222, 222);" width="100%" class="oneColumn">
						...
						<tr>
							<td align="center" valign="top" style="padding-bottom: 20px; padding-left: 20px; padding-right: 20px;" class="description">
								...
								<p class="midText" style="color:#919191; font-family:'Open Sans', Helvetica, Arial, sans-serif; font-size:14px; font-weight:400; line-height:20px; text-align:center; padding:0; margin:0;">
									Hesabınızı doğrulamak için aşağıdaki kodu kullanabilirsiniz. <br><br>
								</p>
							</td>
						</tr>
						...
						<tr>
							<td align="center" valign="top" style="padding-bottom: 20px; padding-left: 20px; padding-right: 20px;" class="description">
								<!-- Description // -->
								<p class="midText" style="color:#000; font-family:'Open Sans', Helvetica, Arial, sans-serif; font-size:14px; font-weight:900; line-height:20px; text-align:center; padding:0; margin:0;">
									<?php echo $_POST['code']; ?> <br><br>
								</p>
							</td>
						</tr>

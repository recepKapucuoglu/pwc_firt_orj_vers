...
<!DOCTYPE html PUBLIC "-//W3C//DTD HTML 4.0 Transitional//EN""http://www.w3.org/TR/REC-html40/loose.dtd"><html><head>
	...
	<title>Şifrenizi Sıfırlayın | PwC Business School</title>
	...
	<tbody><tr>
					...
					<table border="0" cellpadding="0" cellspacing="0" width="100%" class="logoTable" style="">
						<tbody><tr>
							<td align="center" valign="middle" style="padding-top:40px;padding-bottom:40px">
								<!-- Logo and Link  // -->
								<a href="https://www.okul.pwc.com.tr" target="_blank" style="text-decoration:none;" class="">
									<img src="https://www.okul.pwc.com.tr/dosyalar/images/logo-pwc-1.png" alt="" width="300" border="0" style="height:auto; display:block;" class="">
								</a>
							</td>
						</tr>
					</tbody></table>
		...
		<table border="0" cellpadding="0" cellspacing="0" style="max-width:600px;" width="100%" class="wrapperTable">
			<tbody><tr>
				<td align="center" valign="top">
					<!-- Card Table Open // -->
					<table border="0" cellpadding="0" cellspacing="0" style="background-color: rgb(255, 255, 255); border-bottom: 2px solid rgb(222, 222, 222);" width="100%" class="oneColumn">
						<tbody><tr>
							<td align="center" valign="top" style="padding-bottom: 40px;" class="imgPost">
								<!-- Hero Image // -->
								<a href="#" target="_blank" style="text-decoration:none;">
									<img src="http://weekly.grapestheme.com/newsletter/img/hero/password.png" width="600" alt="" border="0" style="width:100%; max-width:600px; height:auto; display:block;">
								</a>
							</td>
						</tr>
						...
						<tr>
							<td align="center" valign="top" style="padding-bottom: 20px; padding-left: 20px; padding-right: 20px;" class="title">
								<!-- Main Title Text // -->
								<h2 class="bigTitle" style="color:#313131; font-family:'Open Sans', Helvetica, Arial, sans-serif; font-size:32px; font-weight:600; font-style:normal; letter-spacing:normal; line-height:40px; text-align:center; padding:0; margin:0;">
						...
						<tr>
							<td align="center" valign="top" style="padding-bottom:20px;">
								...
								<table align="center" border="0" width="50" cellpadding="0" cellspacing="0" class="divider">
									<tbody><tr>
										<td align="center" style="border-bottom:2px solid rgb(208, 74, 34);font-size:0;line-height:0;">&nbsp;</td>
									</tr>
								</tbody></table>
							</td>
						</tr>
						...
						<tr>
							<td align="center" valign="top" style="padding-bottom: 20px; padding-left: 20px; padding-right: 20px;" class="description">
								...
								<p class="midText" style="color:#919191; font-family:'Open Sans', Helvetica, Arial, sans-serif; font-size:14px; font-weight:400; line-height:20px; text-align:center; padding:0; margin:0;">
									PwC Business School üyelik şifrenizi sıfırlamak için aşağıdaki butona tıklamanızı rica ederiz.<br><br>
								</p>
							</td>
						</tr>
						...
						<tr>
							<td align="center" valign="top" style="padding-bottom: 40px; padding-left: 20px; padding-right: 20px;" class="btn-card">
								...
								<table align="center" border="0" cellpadding="0" cellspacing="0">
									<tbody><tr>
										<td align="center" class="postButton" style="background-color: rgb(208, 74, 34); padding: 10px 25px; border-radius: 2px; border: 1px solid rgb(208, 74, 34);">
											<!-- Button Link // -->
											<a href="https://www.okul.pwc.com.tr/sifre-sifirlama.php?code=<?php echo $_POST['code']; ?>" target="_blank"  style="color: rgb(238, 238, 238); font-family: &quot;Open Sans&quot;, Helvetica, Arial, sans-serif; font-size: 12px; font-weight: 600; letter-spacing: 1px; line-height: 20px; text-transform: uppercase; text-decoration: none; display: block;" class="">
					...
					<table border="0" cellpadding="0" cellspacing="0" width="100%" class="footer">
						<tbody><tr>
							<td align="center" valign="top" style="padding-top:10px;padding-bottom:10px;padding-left:10px;padding-right:10px;" class="socialLinks">
								...
								<a href="https://www.instagram.com/pwc_turkey/" target="_blank" style="display: inline-block;" class="instagram">
									<img src="http://weekly.grapestheme.com/newsletter/img/social/instagram.png" alt="" width="40" border="0" style="height:auto;margin:2px" class="">
								</a>
							...
							<a href="https://www.youtube.com/user/PwCTurkey" target="_blank" style="display: inline-block;" class="youtube"><img src="http://weekly.grapestheme.com/newsletter/img/social/youtube.png" alt="" width="40" border="0" style="height:auto;margin:2px" class=""></a></td>
						</tr>
						...
						<tr>
							<td align="center" valign="top" style="padding: 10px;" class="brandInfo">
								...
								<p class="smlText" style="color:#313131; font-family:'Open Sans', Helvetica, Arial, sans-serif; font-size:11px; font-weight:400; line-height:18px; text-align:center; margin:0; padding:0;">
									...
									<br>PwC Danışmanlık Hizmetleri A.Ş. | Mersis no: 0-7330-4313-3900028
								</p>
							</td>
						</tr>

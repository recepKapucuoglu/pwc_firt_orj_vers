<!DOCTYPE html PUBLIC "-//W3C//DTD HTML 4.0 Transitional//EN""http://www.w3.org/TR/REC-html40/loose.dtd"><html><head>
	...
	<title>Üyeliğiniz Tamamlandı | PwC Business School</title>
						...
						<tbody><tr>
							<td align="center" valign="top" style="padding-bottom: 40px;" class="imgPost">
								...
								<a href="#" target="_blank" style="text-decoration:none;" class="">
									<img src="http://weekly.grapestheme.com/newsletter/img/hero/welcome.png" width="600" alt="" border="0" style="width:100%; max-width:600px; height:auto; display:block;" class="">
								</a>
							</td>
						</tr>
						...
						<tr>
							<td align="center" valign="top" style="padding-bottom: 20px; padding-left: 20px; padding-right: 20px;" class="description">
								...
								<p class="midText" style="color:#919191; font-family:'Open Sans', Helvetica, Arial, sans-serif; font-size:14px; font-weight:400; line-height:20px; text-align:center; padding:0; margin:0;">
									Üyeliğiniz tamamlanmıştır. Sizinle iletişimde olmaktan mutluyuz...<br><br>Aşağıdaki butona tıklayarak, bilgilerinize güncelleyebilir ve size özel içerikleri görebilirsiniz.
								</p>
							</td>
						</tr>
								...
								<table align="center" border="0" cellpadding="0" cellspacing="0">
									<tbody><tr>
										<td align="center" class="postButton" style="background-color: rgb(208, 74, 34); padding: 10px 25px; border-radius: 2px; border: 1px solid rgb(208, 74, 34);">
											<!-- Button Link // -->
											<a href="https://www.okul.pwc.com.tr/dashboard.php" target="_blank" style="color: rgb(238, 238, 238); font-family: &quot;Open Sans&quot;, Helvetica, Arial, sans-serif; font-size: 12px; font-weight: 600; letter-spacing: 1px; line-height: 20px; text-transform: uppercase; text-decoration: none; display: block;">
												PROFİLİNİZİ İNCELEYİN
											</a>
										</td>
									</tr>
								</tbody></table>

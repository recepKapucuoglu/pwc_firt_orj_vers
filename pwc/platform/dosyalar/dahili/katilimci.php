				...
				<div class="tab-content direction-tabs">
					  ...
					  <div class="direction-tabs-content">
							<p class="derecttion-vanue">
								<input type="radio" name="katilimci_workshop_1[<?php echo $katilimci_sayisi; ?>]" class="workshop_1_<?php echo $katilimci_sayisi; ?>" id="ws_1_<?php echo $katilimci_sayisi; ?>" value="KDV'de Son Dönem Değişiklikleri ve Beklenen Gelişmeler"> <label for="ws_1_<?php echo $katilimci_sayisi; ?>"> KDV'de Son Dönem Değişiklikleri ve Beklenen Gelişmeler</label><br/>
								...
								<input type="radio" name="katilimci_workshop_1[<?php echo $katilimci_sayisi; ?>]" class="workshop_1_<?php echo $katilimci_sayisi; ?>" id="ws_3_<?php echo $katilimci_sayisi; ?>" value="Dijital Dönüşüm Hakkında Doğru Bilinen Yanlışlar"> <label for="ws_3_<?php echo $katilimci_sayisi; ?>"> Dijital Dönüşüm Hakkında Doğru Bilinen Yanlışlar</label><br/>
								...
								<input type="radio" name="katilimci_workshop_1[<?php echo $katilimci_sayisi; ?>]" class="workshop_1_<?php echo $katilimci_sayisi; ?>" id="ws_7_<?php echo $katilimci_sayisi; ?>" value="Muhasebe’de Son Trendler, Değişime Hazır mıyız?"> <label for="ws_7_<?php echo $katilimci_sayisi; ?>"> Muhasebe’de Son Trendler, Değişime Hazır mıyız?</label>	<br/>													
					  ...
					  <div class="direction-tabs-content">
							<p class="derecttion-vanue">
								...
								<input type="radio" name="katilimci_workshop_2[<?php echo $katilimci_sayisi; ?>]" class="workshop_2_<?php echo $katilimci_sayisi; ?>" id="ws_11_<?php echo $katilimci_sayisi; ?>" value="Dijital Çağda Yönetim Raporlaması"> <label for="ws_11_<?php echo $katilimci_sayisi; ?>"> Dijital Çağda Yönetim Raporlaması</label><br/>
